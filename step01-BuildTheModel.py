...
TRAIN_DIR = "D:/ComputerVision/Train"
VAL_DIR = "D:/ComputerVision/Validate"
...
history = model.fit (x=train_set, validation_data=val_set, batch_size=32 , epochs=40)
...
#save the model :
model.save('D:/ComputerVision/flowers11.keras')
